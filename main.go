...
func main() {
	...
	userHandler := servicehandlers.UserServiceHandler{}
	surveyHandler := servicehandlers.UserSurvayHandler{}
	takesueveyHandler := servicehandlers.TakeSurvayHandler{}
	...
	http.Handle("/api/v1/takesurvey/",takesueveyHandler)
